...
- [Wagner et al., 2002] Wagner, A.K., Soumerai, S.B., Zhang, F., Ross-Degnan, D. "Segmented regression analysis of interrupted time series studies in medication use research." *J. Clinical Pharmacy and Therapeutics*, 27(4), 299-309. — Level (β₂) and slope (β₃) change parameterization; a gradual roll-out is modelled as a slope change.

## Inconclusive Results, Equivalence & Estimation

- [Altman & Bland, 1995] Altman, D.G., Bland, J.M. "Absence of evidence is not evidence of absence." *BMJ*, 311(7003), 485. — A non-significant interval does not establish "no effect."
- [Lakens, 2017] Lakens, D. "Equivalence tests: a practical primer for t-tests, correlations, and meta-analyses." *Social Psychological and Personality Science*, 8(4), 355-362. — TOST: to claim "no meaningful effect" you must test it against a smallest effect of interest, with adequate power.
- [Cumming, 2014] Cumming, G. "The new statistics: why and how." *Psychological Science*, 25(1), 7-29. — Shift from significance testing to estimation + intervals.
...
- [Young, 2019] Young, A. "Channeling Fisher: randomization tests and the statistical insignificance of seemingly significant experimental results." *Quarterly Journal of Economics*, 134(2), 557-598. — Effect-size/randomization ranking is robust to the interval miscalibration that inflates naive p-values.

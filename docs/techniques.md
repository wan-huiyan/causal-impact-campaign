...
| **224-spec robustness grid** | 208/208 valid specs directional positive, top 10 £260K–£295K | The strongest single validation signal when single tests disagree — doesn't share single-spec failure modes |
